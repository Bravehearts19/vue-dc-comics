<template>
    <main>
        <div class="jumbotron">
            <div class="current_series_container">
                <p>Current series</p>
            </div>
        </div>
        ...
        <div class="comics_container">
            <div class="row_cards">
                <ComicsCard v-for="(card, i) in cardsList" :key="i" :img="card.thumb" :title="card.series"/>
                <!-- <div class="comics_card" v-for="(card, i) in cardsList" :key="i">
                    <div class="comics_card_image">
                        <img :src="card.thumb" alt="">
                    </div>
                    <div class="comics_card_title">
                        <h4>
                            {{ card.series }}
                        </h4>
                    </div>
